...
class User extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['idprofil'], 'exist', 'skipOnError' => true, 'targetClass' => User::className(), 'targetAttribute' => ['idprofil' => 'id']],
    ...
    {
        return $this->hasOne(User::className(), ['id' => 'idprofil']);
    }
